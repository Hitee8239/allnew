...
var keys = "7kuzwhGyVPYM8opVVQU9R4tAxFs0LtuZIOrYOPAiAfWbWJuLA33CaUIXFuup%2BZf0L7AfLKPQYlaV3oxooju3hA%3D%3D";
...
app.get('/list', function (req, res, next) {
    Data.findOne({}, function (err, docs) {
        ...
        <body>
        <img src="${docs['imgSrc1']}" width="500" height="500"></img><p>
        <img src="${docs['imgSrc2']}" width="500" height="500"></img><p>
        </body>
        </html>
        `;
        res.end(template);
