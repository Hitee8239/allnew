...
print('\n김유신 included data read of series')
...
print('\n이순신 , 강감찬 included data read of series')
result = myframe.loc[['이순신','강감찬']]
print(type(result))
print(result)

print('\n이순신, 광주 실적  included data read of series')
result = myframe.loc[['이순신'],['광주']]
print(type(result))
print(result)
print('-'*50)

print('\n연산군 ,강감찬 / 광주 ,목포 실적  included data read of series')
result = myframe.loc[['연산군','강감찬'],['광주','목포']]
print(type(result))
print(result)
print('-'*50)

print('\n이순신,강감찬 / 서울,목포 실적  included data read of series')
result = myframe.loc['이순신':'강감찬','서울':'목포']
print(type(result))
print(result)
print('-'*50)

print('\n김유신~광해군/부산 실적  included data read of series')
